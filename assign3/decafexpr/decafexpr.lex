...
>                          { return T_GT; }
if                         { return T_IF; }
(0[xX][0-9a-fA-F]+)|([0-9]+)  { yylval.number = get_intconstant(yytext); return T_INTCONSTANT; }
...
\"([^\n\"\\]*{stresc}?)*\" { yylval.sval = process_string(esc_char(yytext)); return T_STRINGCONSTANT; }
true                       { return T_TRUE; }
var                        { return T_VAR; }
void                       { return T_VOID; }
